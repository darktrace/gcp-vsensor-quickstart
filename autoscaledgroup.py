...
from common import prefixURLCompute, getRef, GenerateOSSensorLBIP, GCP_CLOUD_OPS_TEMPLATE
    ...
    instance_template = {
        ...
        'properties': {
            'properties': {
                ...
                'tags': {
                    'items': ['darktrace-vsensor-mirroring']
                },
                'disks': [{
                    'deviceName': 'boot',
                    'type': 'PERSISTENT',
...
EOF
    ...
    resources = [
        {
            ...
            'properties': {
                ...
                'autoHealingPolicies': [
                    {
                        'healthCheck': getRef(health_check_name),
                        'initialDelaySec': 300
                    }
                ]
            }
    ...
    outputs = [
        ...
        {
            'name': 'mig-ref',
            'value': getRef(MIG_NAME)
        },
        {
            'name': 'mig-ig-ref',
            'value': getRef(MIG_NAME, 'instanceGroup')
        }
    ]
